...
print("Data has been downloaded and saved to 'stock_data.xlsx'")
...
#     data = fetch_data(ticker, multiplier, timespan, from_date.strftime('%Y-%m-%d'), to_date.strftime('%Y-%m-%d'),
#                       API_KEY)
...
#         df.rename(columns={'t': 'timestamp', 'o': 'open', 'c': 'close', 'h': 'high', 'l': 'low', 'v': 'volume'},
#                   inplace=True)
